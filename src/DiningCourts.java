...
public class DiningCourts {
    public static void main(String[] args) {
        try
        {
            ...
            for (int i=0; i<numDiningCourts; i++) diningCourtLines[i]=Integer.parseInt(currentLine.nextToken());
            int richard = 0;
            while ((diningCourtLines[richard%numDiningCourts]-richard)<=0) richard++;
